...
//programa per introduir nomes matricules italianes i et diu on esta l'error
...
public class MatriculaValida{
    public static void main (String[] args){
        ...
        if((paraula.length())>=7){
            ...
            }else{System.out.println("No és una matrícula italiana vàlida: massa curta");}
        }else{System.out.println("No és una matrícula italiana vàlida: massa llarga");}
    }
}
