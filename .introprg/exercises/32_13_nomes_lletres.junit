/*
    Unit testing methods for exercise 02_10_nomes_lletres
*/
...
public class TestExercise {
    ...
    @Test
    @DisplayName("Test hi és mòdul filtraLletres()")
    public void prgtestX1filtraLletres() {
        Class classe = NomesLletres.class;
        String modulObjectiu = "filtraLletres";
